...
class _ProductDetailsScreenState extends ConsumerState<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Product product = products.firstWhere((p) => p.id == widget.productId);
    ...
    favoriteProducts.contains(product) ? isFavorite = true : isFavorite = false;
                  ...
                  Column(
                    ...
                    children: [
                      IconButton(
                        onPressed: (){
                          isFavorite ? 
                            ref.read(favoritesNotifierProvider.notifier).removeFavorite(product.id) : 
                            ref.read(favoritesNotifierProvider.notifier).addFavorite(product.id);
                        },  
                        icon: 
