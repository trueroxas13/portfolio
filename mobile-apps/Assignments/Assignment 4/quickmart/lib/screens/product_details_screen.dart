...
import 'package:quickmart/providers/favorites_db_provider.dart';
import 'package:quickmart/providers/product_provider.dart';
import 'package:quickmart/providers/selected_product_provider.dart';
...
class _ProductDetailsScreenState extends ConsumerState<ProductDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref
        ...
        .getProductById(widget.productId.toString()).listen((data){
          ref.watch(selectedProductNotifierProvider.notifier).setProduct(data!);
        });

    product = ref.watch(selectedProductNotifierProvider);

    final favoriteState = ref.watch(favoriteProviderNotifier.notifier).isFavorite(product);
                            ...
                            Row(
                              children: [
                                ...
                                IconButton(
                                  onPressed: () {
                                    favoriteState ? 
                                    ref.watch(favoriteProviderNotifier.notifier).removeFavorite(product) :
                                    ref.watch(favoriteProviderNotifier.notifier).addFavorite(product);
                                  },
                                  icon: Icon(
                                    favoriteState
                                        ? Icons.favorite
                                        : Icons.favorite_border,
                                    color: favoriteState ? Colors.red : Colors.grey,
                                  ),
                                )
                              ],
                            ),
