              ...
              productsAsyncValue.when(
                data: (products) {
                  return ElevatedButton(
                    onPressed: () {
                      var temp = ref.watch(favoriteProviderNotifier.notifier).getFavoriteProducts();
                      ref
                          .read(cartProviderNotifier.notifier)
                          .addAllProductsToCart(temp);
                    },
                    child: Row(
                      children: const [
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              color: Colors.red,
                              onPressed: () {
                                ref.read(favoriteProviderNotifier.notifier).isFavorite(product) ?
